...
REM
REM Generated by Vivado on Thu Aug 21 17:40:36 -0400 2025
...
echo "xvlog --incr --relax -L uvm -prj Vertical_Counter_vlog.prj"
call xvlog  --incr --relax -L uvm -prj Vertical_Counter_vlog.prj -log xvlog.log
