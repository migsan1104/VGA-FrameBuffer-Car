...
HD_PWD='C:/Xilinx/VGA/VGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Horizontal_Counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Horizontal_Counter.tcl
